              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((u) => (
                  ...
                  >
                    ...
                    <td
                      style={{ color: "var(--sup-text-muted)", fontSize: 13 }}
                    >
                      {u.email}
                    </td>
                    <td>
                      <span className={`${p.badge} ${p[ROLE_MAP[u.role]]}`}>
                        {u.role}
                      </span>
                    </td>
                    ...
                    <td style={{ textAlign: "center" }}>
                      {u.open > 0 ? (
                        <span className={`${p.badge} ${p.bOpen}`}>
                          {u.open}
                        </span>
                      ) : (
                        <span
                    ...
                    <td
                      style={{ color: "var(--sup-text-muted)", fontSize: 12 }}
                    >
                      {u.joined}
                    </td>
        ...
        >
          <div className={p.modal} style={{ maxWidth: 600 }}>
            <div className={p.modalHead}>
              <div className={p.avatarCell}>
                ...
                <div>
                  ...
                  >
                    <span className={`${p.badge} ${p[ROLE_MAP[user.role]]}`}>
                      {user.role}
                    </span>
                    <span
            ...
            <div className={p.modalBody}>
              ...
              >
                <Ticket size={13} style={{ verticalAlign: "middle" }} /> Recent
                Tickets
              </h4>
              <div
