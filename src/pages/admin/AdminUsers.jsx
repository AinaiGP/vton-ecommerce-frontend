...
function RoleBadge({ role }) {
  ...
  return (
    <span className={`${t.badge} ${map[role] || t.badgeDraft}`}>{role}</span>
  );
}
...
export default function AdminUsers() {
  ...
  useEffect(() => {
    // TODO: wire admin users to real API — Phase X
  }, []);
  ...
  return (
    <AdminLayout
      ...
      pageSubtitle="Monitor customer accounts and control privileges."
      breadcrumb="Users"
    >
      {/* Toolbar */}
            ...
            <tbody>
              {paged.length === 0 ? (
                ...
                paged.map((user, i) => (
                  <tr
                    key={user.id}
                    style={{ opacity: user.status === "Banned" ? 0.65 : 1 }}
                  >
                    <td
                      style={{
          ...
          <div className={t.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={t.modalBody}>
              ...
              <div className={t.formRow}>
                ...
                <div className={t.formGroup}>
                  <label className={t.label}>Orders</label>
                ...
                <div className={t.formGroup}>
                  ...
                  <p style={{ margin: 0 }}>{viewUser.joined}</p>
                </div>
              </div>
            </div>
          ...
          <div className={t.modal} onClick={(e) => e.stopPropagation()}>
            <div className={t.modalHead}>
              <h2 className={t.modalTitle}>
                {editUser._new ? "Add New User" : "Edit User"}
              </h2>
              <button
                className={t.modalClose}
            ...
            <form onSubmit={saveEdit}>
              ...
              <div className={t.modalFoot}>
                ...
                <button type="submit" className={`${t.btn} ${t.btnPrimary}`}>
                  <Check size={14} />{" "}
                  {editUser._new ? "Add User" : "Save Changes"}
                </button>
              </div>
            </form>
          </div>
