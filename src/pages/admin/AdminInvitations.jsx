      ...
      <div className={t.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={t.modalBody}>
          ...
          >
            ...
            >
              📧 An invitation email will be sent with a 7-day expiry link. The
              user must sign up using this email address.
            </p>
          </div>
        </div>
...
export default function AdminInvitationsPage() {
  ...
  useEffect(() => {
    // TODO: wire invitations to real API — Phase X
  }, []);
  ...
  return (
    <AdminLayout
      ...
      pageSubtitle="Invite admins, vendors, and support staff to join AINAI."
    ...
    >
                ...
                <tr>
                  <td colSpan={6}>
                    <div className={t.emptyState}>
                      ...
                      <h3 className={t.emptyTitle}>No invitations found</h3>
                    </div>
                  </td>
                </tr>
              ) : (
      ...
      {showInvite && (
        <InviteModal onSave={addInvite} onClose={() => setShowInvite(false)} />
      )}
    </AdminLayout>
  );
}
