      ...
      <main className={styles.main}>
        {!order && (
          <div className={styles.card}>
            <p className={styles.emptyState}>No order data available.</p>
          </div>
        )}
        {order && (
          <>
              ...
              <div className={styles.headerInfo}>
                <div className={styles.headerMeta}>
                  ...
                  <p className={styles.orderDate}>
                    {t("track.date")}: {order.date} • {order.items.length}{" "}
                    {t("track.itemsCount")}
                  </p>
                </div>
                ...
                <div className={styles.card}>
                  <div className={styles.stepperHead}>
                    ...
                    <p className={styles.cardSub}>
                      {t(
                        "track.status." +
                          TRACKING_STEPS[currentStep].key +
                          "_sub",
                      )}
                    </p>
                  </div>
                  ...
                  <div className={styles.deliveryContent}>
                    ...
                    <div className={styles.deliveryRow}>
                      ...
                      <div>
                        ...
                        <p className={styles.sidebarVal}>
                          {order.shipping.estDate}
                        </p>
                      </div>
                    </div>
                    <div className={styles.deliveryRow}>
